...
with(this){return _c('p',[_v("Here are the other classes in "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" (omitted from the class diagram above) that are used for filtering the list which is exposed to outsiders:")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("When filtering is needed, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("XYZCommand")]),_v(" class ("),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("XYZ")]),_v(" is a placeholder for the specific command name e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("SelectCommand")]),_v(") passes a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Predicate")]),_v(" object (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("IsSamePersonCommand")]),_v(") to the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" component.")]),_v(" "),_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" component then ensures that the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Predicate")]),_v(" is not null before setting this "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Predicate")]),_v(" in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ObservableList<Person>")]),_v(".")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The feature enables us to select a particular client using an index and displays the profile. The mechanism is then facilitated by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PersonProfile")]),_v(" UI component. Additionally, the following classes were modified slightly to integrate the select feature:")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandResult")]),_v("  —  Added a new "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("updateProfile")]),_v(" field and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandResult#isupdateProfile()")]),_v(" method to let the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("MainWindow")]),_v(" know if there is a need to update the details in the aforementioned "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PersonProfile")]),_v(".")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ModelManager")]),_v("  —  Added a new "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("selectedPerson")]),_v(" field which is initially declared with "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("null")]),_v(". Reason: When a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ModelManager")]),_v(" is just built, no select command is called yet, thus there should not be any "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("selectedPerson")]),_v(". Additionally, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#updateSelectedPerson()")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#getSelectedPerson()")]),_v(" were also added.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("MainWindow")]),_v("  —  Modified the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("MainWindow#fillInnerParts()")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("MainWindow#executeCommand()")]),_v(" methods to show and update the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PersonProfile")]),_v(".")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditCommand")]),_v("  —  Modified the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditCommand#execute()")]),_v(" method to return a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandResult")]),_v(" with a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("true")]),_v(" for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("updateProfile")]),_v(" if the person-to-edit is currently selected. Reason: This is to enable the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PersonProfile")]),_v(" to reflect the changes made to the selected person, if needed.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The following sequence diagram shows how a select operation goes through the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("MainWindow")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PersonProfile")]),_v(" component:")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Select using index.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Easy to implement.")]),_v(" "),_c('li',[_v("Cons: Not very intuitive, have to look up the name, reference the index before selecting the person.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" Selecting by name.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: More intuitive and easy to select.")]),_v(" "),_c('li',[_v("Cons: May result in bugs due to the issue of duplicate names.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{more aspects and alternatives to be added}")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_v("is a financial advisor")]),_v(" "),_c('li',[_v("is currently studying at the same time")]),_v(" "),_c('li',[_v("has a need to manage over 50 clients while juggling with school commitments")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to list people")]),_v(" "),_c('li',[_v("AddressBook shows a list of people")]),_v(" "),_c('li',[_v("User requests to delete a specific person in the list")]),_v(" "),_c('li',[_v("AddressBook deletes the person\nUse case ends.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User edits an existing client's information in FAPro by providing the updated information.")]),_v(" "),_c('li',[_v("FAPro validates the provided information and edits the information.")]),_v(" "),_c('li',[_v("FAPro shows the updated client information in the list.\nUse case ends.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User provides one or more keywords for the seach.")]),_v(" "),_c('li',[_v("FAPro performs a case-insensitive search for people whose names contain any of the provided keywords.")]),_v(" "),_c('li',[_v("FAPro returns a list of people matching at least one keyword.\nUse case ends.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to clear all contacts.")]),_v(" "),_c('li',[_v("The system clears all contacts.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User enters the exit command.")]),_v(" "),_c('li',[_v("FAPro closes the window and its system.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Tagging a client as last contacted")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to tag a client with date and time.")]),_v(" "),_c('li',[_v("The system tags the client as 'last contacted' with given date and time.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("2a. Client name does not exist.\n"),_c('ul',[_c('li',[_v("2a1. The system shows an error message.\nUse case resumes at step 1.")])])]),_v(" "),_c('li',[_v("2b. The system found more than 1 matching name.\n"),_c('ul',[_c('li',[_v("2b1. The system lists all matching clients' name with their ID code and other details for identification.")]),_v(" "),_c('li',[_v("2b2. User enters the ID code shown from the list.\nSteps 2b1-2b2 are repeated until the data entered are valid.\nUse case resumes at step 2.")])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.3.0")]),_v(", generated on Mon, 25 Mar 2024, 16:20:43 GMT+8]")])])])}
}];
