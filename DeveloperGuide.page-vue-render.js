...
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": manage contacts faster than a typical mouse/GUI driven app and revolutionizes client engagement\nfor financial advisors by facilitating strategic communication and personalised service.")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to add a new client with the relevant information.")]),_v(" "),_c('li',[_v("FApro adds the client.")]),_v(" "),_c('li',[_v("FApro shows the client information in the list. "),_c('br'),_v("\nUse case ends.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to edit a specific client's information.")]),_v(" "),_c('li',[_v("FApro edits the client's information and shows the updated client information in the list. "),_c('br'),_v("\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. The given index is invalid.\n"),_c('ul',[_c('li',[_v("1a1. FApro shows an error message. "),_c('br'),_v("\nUse case resumes at step 1.")])])]),_v(" "),_c('li',[_v("1b. The information provided is invalid or incomplete.\n"),_c('ul',[_c('li',[_v("1b1. FApro shows the error message and the correct format. "),_c('br'),_v("\nUse case resumes at step 1.")])])]),_v(" "),_c('li',[_v("1c. The updated client's name already exists in FApro.\n"),_c('ul',[_c('li',[_v("1c1. FApro shows a message to let the user know about the duplicated entry. "),_c('br'),_v("\nUse case resumes at step 1.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to list clients.")]),_v(" "),_c('li',[_v("FApro shows a list of clients.")]),_v(" "),_c('li',[_v("User requests to add a specified plan to a specific client in the list.")]),_v(" "),_c('li',[_v("AddressBook adds the plan to the client. "),_c('br'),_v("\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("User requests to find clients containing any of the specified plans")]),_v(" "),_c('li',[_v("FApro shows a list of clients")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("User requests a list of clients sorted by how long ago they were last contacted.")]),_v(" "),_c('li',[_v("FApro shows the list of clients who were last contacted, sorted by least to most recent date.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Finding all upcoming contacts with appointments")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to find clients containing an upcoming appointment.")]),_v(" "),_c('li',[_v("FApro shows the list of clients, ordering them from the nearest to the farthest upcoming appointment based on date.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Clearing all contacts in FApro")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to clear all contacts.")]),_v(" "),_c('li',[_v("FApro clears all contacts.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to exit the application.")]),_v(" "),_c('li',[_v("FApro closes the window and its system.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("DBMS")]),_v(": Database Management System, a software suite that facilitates the creation, management, and manipulation of databases.")]),_v(" "),_c('li',[_c('strong',[_v("Remote server")]),_v(": A computer system or software application that provides services or resources to other computers or clients over a network, typically the internet.")]),_v(" "),_c('li',[_c('strong',[_v("GUI")]),_v(": Graphic User Interface, a visual interface that allows users to interact with electronic devices or software using graphical icons, menus, and other graphical elements, rather than text-based commands")])])}
},function anonymous(
) {
